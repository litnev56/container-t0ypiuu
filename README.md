...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-t0ypiuu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-t0ypiuu.containers.anotherwebservice.com/
...
```
git clone git@github.com:litnev56/container-t0ypiuu.git
cd container-t0ypiuu
```
...
```
docker attach container-t0ypiuu
```
